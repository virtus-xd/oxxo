            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="https://maps.app.goo.gl/MqHWDsM3Ei3d7jvU9"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg hover:text-amber-500 transition-colors block"
                  >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+905434025073" className="text-lg hover:text-amber-500 transition-colors">
                    +90 543 402 50 73
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:oxxomimarlik@gmail.com" className="text-lg hover:text-amber-500 transition-colors">
                    oxxomimarlik@gmail.com
                  </a>
                </div>
              </div>
            </div>
